...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Carry Wang', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Carry的秘密花园', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://carry-notion-next.vercel.app/', // 网站地址
